...
let modulePaths = {
 ...
 "packages/contador_de_pessoas/main": "packages/contador_de_pessoas/main.ddc",
 "packages/contador_de_pessoas/main_web_entrypoint": "packages/contador_de_pessoas/main_web_entrypoint.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/contador_de_pessoas/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:contador_de_pessoas/main_web_entrypoint.dart") {
          // Clear static caches.
